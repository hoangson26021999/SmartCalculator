...
public class DrawDTB4 extends AppCompatActivity {
    ...
    // Ham ve do thi //
    public LineGraphSeries<DataPoint> drawgraph(double a, double b, double c, double d , double e) {
        LineGraphSeries<DataPoint> seriesTest;
        double x, y;
        x = -3.00;
        seriesTest = new LineGraphSeries<>();
        int numDataPoint = 600;
        for (int i = 0; i < numDataPoint; i++) {
            x = x + 0.01;
            y = a * x * x * x * x + b * x * x * x + c * x * x + d * x + e;
            seriesTest.appendData(new DataPoint(x, y), true, 600);
        }
        return seriesTest;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_draw_dtb4);
        ...
        edthst5 = (EditText) findViewById(R.id.edhst5);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DrawDTB4.this, Activity2.class);
        ...
        Draw.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String Shst5 = edthst5.getText().toString();


                if (Shst1.equals("") || Shst2.equals("") || Shst3.equals("") || Shst4.equals("")|| Shst5.equals("")) {
                    Toast.makeText(DrawDTB4.this, "Bạn phải điền đầy đủ hệ số đã ", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    Double hst5 = Double.parseDouble(Shst5);
                    if (hst1 == 0 ) {
                        Toast.makeText(DrawDTB4.this, "Error ", Toast.LENGTH_SHORT).show();
                    } else {
                        // ve do thi , xu li trung lap //
                        // neu nhu su dung nut draw 2 lan lien tiep thi no se ve  2 do thi len cung luc  =) phai clear trc //
                        graph.removeAllSeries();
                        series1 = drawgraph(hst1, hst2, hst3, hst4 ,hst5 );
